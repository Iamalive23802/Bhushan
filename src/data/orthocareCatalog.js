...
const saleItemsRaw = [
  ...
  { slug: 'surgical-instruments-sale', name: 'Surgical Instruments', listingType: 'sale', shortDescription: 'Common surgical instruments and procedure tools.', longDescription: 'Scissors, forceps, retractors, needle holders, suction tips, and basic surgical tools for clinics and nursing setups.', priceMode: 'on-request', availability: 'available', heroImageAlt: 'Assorted surgical instruments with labels.', features: ['Clinic essentials', 'Multiple instrument types', 'Bulk orders available'] },
]
...
const rentItemsRaw = [
  ...
  { slug: 'ventilator-rent', name: 'Ventilator Machine', listingType: 'rent', shortDescription: 'Hospital-grade ventilator support for ICU-at-home care.', longDescription: 'Ventilator machine rental with setup support for prescribed respiratory care and monitored home ICU arrangements.', priceMode: 'on-request', availability: 'available', heroImageAlt: 'Ventilator machine with breathing circuit and monitor.', features: ['Setup support', 'Home ICU compatible', 'Use under medical supervision'] },
  { slug: 'defibrillator-rent', name: 'Defibrillator', listingType: 'rent', shortDescription: 'Emergency defibrillator rental for clinical setups.', longDescription: 'Portable defibrillator unit for hospitals, clinics, events, and monitored care environments with basic usage guidance.', priceMode: 'on-request', availability: 'available', heroImageAlt: 'Portable medical defibrillator with display and paddles.', features: ['Portable unit', 'Emergency-ready', 'Clinic and event support'] },
  { slug: 'examination-table-rent', name: 'Examination Table', listingType: 'rent', shortDescription: 'Adjustable examination table for clinical procedures.', longDescription: 'Padded examination table with adjustable backrest for checkups, dressing, physiotherapy, and bedside procedures.', priceMode: 'on-request', availability: 'available', heroImageAlt: 'Adjustable padded examination table.', features: ['Adjustable backrest', 'Easy-clean surface', 'Clinic or home setup'] },
  { slug: 'stretcher-rent', name: 'Stretcher', listingType: 'rent', shortDescription: 'Patient stretcher for transfer and emergency use.', longDescription: 'Foldable patient stretcher with wheels and side rails for safe patient transport between home, ambulance, and facility.', priceMode: 'on-request', availability: 'available', heroImageAlt: 'Orange wheeled patient stretcher.', features: ['Foldable frame', 'Wheeled transport', 'Patient safety straps'] },
]
